...
contract SplitsFactory is ISplitsFactory, Ownable {
    ...
    /// @dev 1% tip for the 0xSplit team (10,000 = 1%)
    uint32 constant ONE_PERCENT = 1e4;
    ...
    function create(address[] calldata beneficiaries) external override returns (address) {
        ...
        address split = ISplitMain(_splitMain).createSplit(accounts, shares, ONE_PERCENT, address(0));
